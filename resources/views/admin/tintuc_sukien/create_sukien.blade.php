                        ...
                        <form action="{{ route('admin.sukien.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('trang_thai') is-invalid @enderror" 
                                    ...
                                    <option value="Sắp diễn ra" {{ old('trang_thai') == 'Sắp diễn ra' ? 'selected' : '' }}>Sắp diễn ra</option>
                                    <option value="Đang diễn ra" {{ old('trang_thai') == 'Đang diễn ra' ? 'selected' : '' }}>Đang diễn ra</option>
                                    <option value="Đã kết thúc" {{ old('trang_thai') == 'Đã kết thúc' ? 'selected' : '' }}>Đã kết thúc</option>
                                </select>
                                @error('trang_thai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
